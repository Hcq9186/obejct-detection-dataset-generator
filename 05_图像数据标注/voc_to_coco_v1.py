...
PRE_DEFINE_CATEGORIES = {"voids and pits": 1,
"corrosion": 2,
"crack": 3,
"hole": 4,
"separation": 5,
...
if __name__ == '__main__':
    voc_root = 'VOC2007'
    root_path = '/data/objectDetection/dataset/mydataset/VOCdevkit'
    ...
    xml_dir = os.path.join(root_path, voc_root, 'Annotations') #已知的voc的标注
    ...
    for xml_file in xml_list:
        ...
        shutil.copy(os.path.join(root_path, voc_root, 'JPEGImages', img_name),
