...
import os
import numpy as np
imageDir="D:\WareHouse\Workspace\Programming\PyCharm\obejct-detection-dataset-generator\\05_图像数据标注\demo\coco\images"      #要改变的图片的路径文件夹
saveDir=get_project_path()+"\\"+config['save_path']+"/混凝土桥梁_aug"     #要保存的图片的路径文件夹
